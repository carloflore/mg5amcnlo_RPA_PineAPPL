...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,2),2,4,1,2,1,86,H)
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,5),2,4,2,1,1,87,H)
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,8),2,4,3,1,1,88,H)
C     Coefficient construction for loop diagram with ID 7
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,10),1,4,4,1,1,89,H)
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,13),2,4,5,1,1,90,H)
C     Coefficient construction for loop diagram with ID 9
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,16),2,4,6,1,1,91,H)
...
C     Coefficient construction for loop diagram with ID 13
      ...
      CALL UPDATE_WL_2_0(WL(1,0,1,25),4,COEFS,4,4,WL(1,0,1,26))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,26),2,4,10,1,1,95,H)
C     Coefficient construction for loop diagram with ID 14
      CALL FFV1L3_1(PL(0,24),W(1,3),GC_5,MDL_MT,MDL_WT,PL(0,27),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,27))
      CALL FFV1L2P0_3(PL(0,27),W(1,9),GC_5,ZERO,ZERO,PL(0,28),COEFS)
      CALL UPDATE_WL_2_0(WL(1,0,1,27),4,COEFS,4,4,WL(1,0,1,28))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,28),2,4,11,1,1,96,H)
C     Coefficient construction for loop diagram with ID 15
      CALL VVV1L2P0_1(PL(0,24),W(1,2),GC_4,ZERO,ZERO,PL(0,29),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,29))
...
C     Coefficient construction for loop diagram with ID 17
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,34),3,4,14,1,1,99,H)
C     Coefficient construction for loop diagram with ID 18
      CALL VVVV1L2P0_1(PL(0,24),W(1,8),W(1,2),GC_6,ZERO,ZERO,PL(0,35)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,35))
      CALL VVVV3L2P0_1(PL(0,24),W(1,8),W(1,2),GC_6,ZERO,ZERO,PL(0,36)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,36))
      CALL VVVV4L2P0_1(PL(0,24),W(1,8),W(1,2),GC_6,ZERO,ZERO,PL(0,37)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,37))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,35),1,4,15,2,1,100,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,36),1,4,15,2,1,101,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,37),1,4,15,2,1,102,H)
C     Coefficient construction for loop diagram with ID 19
      CALL FFV1L2_1(PL(0,27),W(1,2),GC_5,MDL_MT,MDL_WT,PL(0,38),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,27),4,COEFS,4,4,WL(1,0,1,38))
      CALL FFV1L2P0_3(PL(0,38),W(1,4),GC_5,ZERO,ZERO,PL(0,39),COEFS)
      CALL UPDATE_WL_3_0(WL(1,0,1,38),4,COEFS,4,4,WL(1,0,1,39))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,39),3,4,16,1,1,103,H)
C     Coefficient construction for loop diagram with ID 20
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,42),2,4,17,1,1,104,H)
C     Coefficient construction for loop diagram with ID 21
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,45),2,4,18,1,1,105,H)
C     Coefficient construction for loop diagram with ID 22
      CALL VVVV1L2P0_1(PL(0,11),W(1,8),W(1,1),GC_6,ZERO,ZERO,PL(0,46)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1,46))
      CALL VVVV3L2P0_1(PL(0,11),W(1,8),W(1,1),GC_6,ZERO,ZERO,PL(0,47)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1,47))
      CALL VVVV4L2P0_1(PL(0,11),W(1,8),W(1,1),GC_6,ZERO,ZERO,PL(0,48)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1,48))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,46),1,4,19,2,1,106,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,47),1,4,19,2,1,107,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,48),1,4,19,2,1,108,H)
...
C     Coefficient construction for loop diagram with ID 25
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,56),3,4,22,1,1,111,H)
C     Coefficient construction for loop diagram with ID 26
     ...
     $ ,COEFS)
      ...
      CALL UPDATE_WL_0_1(WL(1,0,1,57),4,COEFS,4,4,WL(1,0,1,60))
      CALL VVV1L2P0_1(PL(0,58),W(1,8),GC_4,ZERO,ZERO,PL(0,61),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,58),4,COEFS,4,4,WL(1,0,1,61))
      CALL VVV1L2P0_1(PL(0,59),W(1,8),GC_4,ZERO,ZERO,PL(0,62),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,59),4,COEFS,4,4,WL(1,0,1,62))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,60),1,4,23,2,1,112,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,61),1,4,23,2,1,113,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,62),1,4,23,2,1,114,H)
C     Coefficient construction for loop diagram with ID 27
      CALL VVVV1L2P0_1(PL(0,4),W(1,2),W(1,1),GC_6,ZERO,ZERO,PL(0,63)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,63))
      CALL VVVV3L2P0_1(PL(0,4),W(1,2),W(1,1),GC_6,ZERO,ZERO,PL(0,64)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,64))
      CALL VVVV4L2P0_1(PL(0,4),W(1,2),W(1,1),GC_6,ZERO,ZERO,PL(0,65)
     $ ,COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,65))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,63),1,4,24,1,1,115,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,64),1,4,24,1,1,116,H)
      CALL CREATE_LOOP_COEFS(WL(1,0,1,65),1,4,24,1,1,117,H)
C     Coefficient construction for loop diagram with ID 28
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,67),2,1,1,1,1,118,H)
C     Coefficient construction for loop diagram with ID 29
      CALL GHGHGL1_2(PL(0,0),W(1,1),GC_4,ZERO,ZERO,PL(0,68),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),1,COEFS,1,1,WL(1,0,1,68))
      CALL GHGHGL1_2(PL(0,68),W(1,2),GC_4,ZERO,ZERO,PL(0,69),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,68),1,COEFS,1,1,WL(1,0,1,69))
      CALL GHGHGL1_2(PL(0,69),W(1,8),GC_4,ZERO,ZERO,PL(0,70),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,69),1,COEFS,1,1,WL(1,0,1,70))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,70),3,1,14,1,1,119,H)
C     Coefficient construction for loop diagram with ID 30
      ...
      CALL UPDATE_WL_2_1(WL(1,0,1,72),1,COEFS,1,1,WL(1,0,1,73))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,73),3,1,14,1,1,120,H)
...
C     Coefficient construction for loop diagram with ID 32
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,78),3,4,14,1,4,122,H)
C     Coefficient construction for loop diagram with ID 33
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,81),3,4,14,1,4,123,H)
C     Coefficient construction for loop diagram with ID 34
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,83),2,4,25,1,1,124,H)
C     Coefficient construction for loop diagram with ID 35
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,86),3,4,26,1,1,125,H)
C     Coefficient construction for loop diagram with ID 36
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,89),3,4,26,1,1,126,H)
C     Coefficient construction for loop diagram with ID 37
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,91),2,4,27,1,1,127,H)
C     Coefficient construction for loop diagram with ID 38
      CALL FFV1L1_2(PL(0,54),W(1,8),GC_5,MDL_MT,MDL_WT,PL(0,92),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,54),4,COEFS,4,4,WL(1,0,1,92))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,92),3,4,28,1,1,128,H)
C     Coefficient construction for loop diagram with ID 39
      CALL FFV1L2_1(PL(0,51),W(1,8),GC_5,MDL_MT,MDL_WT,PL(0,93),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,51),4,COEFS,4,4,WL(1,0,1,93))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,93),3,4,28,1,1,129,H)
