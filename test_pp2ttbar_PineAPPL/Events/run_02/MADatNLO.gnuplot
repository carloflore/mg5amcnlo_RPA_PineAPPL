...
#
################################################################################
# /home/charlie/research/mg5amcnlo_RPA_PineAPPL/test_pp2ttbar_PineAPPL/bin/internal/histograms.py /home/charlie/research/mg5amcnlo_RPA_PineAPPL/test_pp2ttbar_PineAPPL/SubProcesses/P0_gg_ttx/all_G1/MADatNLO.HwU /home/charlie/research/mg5amcnlo_RPA_PineAPPL/test_pp2ttbar_PineAPPL/SubProcesses/P0_uux_ttx/all_G1/MADatNLO.HwU /home/charlie/research/mg5amcnlo_RPA_PineAPPL/test_pp2ttbar_PineAPPL/SubProcesses/P0_uxu_ttx/all_G1/MADatNLO.HwU --out=/home/charlie/research/mg5amcnlo_RPA_PineAPPL/test_pp2ttbar_PineAPPL/Events/run_02/MADatNLO --gnuplot --band=[] --lhapdf-config=lhapdf-config --sum --keep_all_weights --no_open
reset
...
set format y '10^{%T}'
set yrange [5.1247e+02:8.7747e+03]
...
unset label
unset format
set yrange [-1.8665e-01:3.3294e-01]
...
set format y '10^{%T}'
set yrange [3.0571e+02:6.9925e+03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
unset label
unset format
set yrange [-3.7085e-01:6.2739e-01]
set origin 0.0000e+00, 3.5000e-01
set size 1.0000e+00, 1.5000e-01
set mytics 2
set ytics auto
