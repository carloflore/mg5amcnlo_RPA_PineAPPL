...
data = [
    {
        ...
        "mid"      : np.array([1, 2, 3, 4, 5]),
        "pdf_results" : [
            (
                    r"110000",
                    np.array([6.3776129e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
                    np.array([6.3776129e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
                    np.array([6.3776129e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
                ),
            (
                    r"110950",
                    np.array([7.3943574e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
                    np.array([6.8451566e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
                    np.array([7.9435583e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
                ),
        ],
        "qcd_y"    : np.array([6.3776129e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
        "qcd_min"  : np.array([5.7300606e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
        "qcd_max"  : np.array([6.9575710e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
        "y"        : np.array([6.3776129e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
        "ymin"     : np.array([5.7300606e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
        "ymax"     : np.array([6.9575710e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]),
        "channels" : [
            (r"$\mathrm{g}\mathrm{g}$", np.array([5.7834572e2, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0])),
            (r"$\mathrm{d}\bar{\mathrm{d}} + \mathrm{u}\bar{\mathrm{u}} + \mathrm{s}\bar{\mathrm{s}} + \mathrm{c}\bar{\mathrm{c}}$", np.array([7.8416645e1, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0])),
            (r"$\mathrm{d}\mathrm{g} + \mathrm{u}\mathrm{g} + \mathrm{s}\mathrm{g} + \mathrm{c}\mathrm{g}$", np.array([-1.4921254e1, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0])),
            (r"$\bar{\mathrm{c}}\mathrm{g} + \bar{\mathrm{s}}\mathrm{g} + \bar{\mathrm{u}}\mathrm{g} + \bar{\mathrm{d}}\mathrm{g}$", np.array([-4.0798179e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0, 0.0000000e0]))
        ],
    },
]
metadata = {
    "pineappl_gitversion": r"cargo:1.2.0",
}
